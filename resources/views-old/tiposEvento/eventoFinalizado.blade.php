...
<x-layouts.base 
    ...
    <p>< ** aquí se muestra la vista de evento finalizado, no se puede interactuar 
        solo ver (independientemente de que sea con o sin presupuesto) ></p>
    <article>
        <h2>Evento Fianlizado</h2>
        <div>
