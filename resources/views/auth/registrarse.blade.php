...
<body class="bg-blue-100">
    ...
    <main class="grid  grid-cols-1 md:grid-cols-3 content-center h-screen mt-24">
        ...
        <div class="grid bg-blue-300 md:col-start-2 border-2 rounded-md border-blue-500  p-4 sm:w-full">
            ...
            <form  action="{{route('registrarse')}}" method="POST">
                ...
                <div class="grid content-center lg:flex md:flex lg:justify-center md:justify-center">
                    <a class="w-3/4 sm:w-full md:w-full lg:w-1/2 border border-black rounded-md bg-blue-500 py-1 p-2 my-2 mx-2 text-center" href="{{e(route('login'))}}">Login</a>
                    <button class="w-3/4 sm:w-full md:w-full lg:w-1/2 border border-black rounded-md bg-green-500 py-1 p-2 my-2 mx-2" type="submit">Registrarse</button>
                </div>
