...
<body>
    ...
    <input type="text" name="nombre_completo" value="{{old('nombre_completo')}}" >@error('nombre_completo') <span> {{$message}}</span> @enderror<br>
    <label for="alias">* Alias:</label>
    <input type="text" name="alias" value="{{old("alias")}}" >@error('alias') <span> {{$message}}</span> @enderror<br>
    <label for="email">* Email:</label>
    <input type="email" name="email" value="{{old('email')}}" >@error('email') <span> {{$message}}</span> @enderror<br>
    ...
    <input type="text" name="localidad" value="{{old('localidad')}}" >@error('localidad') <span> {{$message}}</span> @enderror<br>
    ...
    <input type="password" name="password" >@error('password') <span> {{$message}}</span> @enderror<br>
    <label for="confirm-password">* Confirmar contraseña:</label>
    <input type="password" name="confirm-password" >@error('same') <span> {{$message}}</span> @enderror<br>
