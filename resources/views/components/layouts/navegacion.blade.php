<nav class="fixed h-full from-gray-200 to-gray-400 mt-10 overflow-hidden w-14 group border-r-2 border-gray-200 ease-in-out duration-300" id="main-menu">{{--  hover:w-52 --}}

        <div class="relative bg-gradient-to-r bg-gray-200  h-full p-3 shadow-lg">
            <div class="grid place-items-center space-x-4 ml-10 mb-2">
                ...
                <li class="w-48">
                    {{-- <a href="{{e(route('evento.select.tipo'))}}" class="flex items-center space-x-3 text-gray-700 py-2 rounded-md font-medium hover:bg-sky-50 focus:bg-gray-200 focus:shadow-outline"> --}}
                        ...
                        <div  class="flex  items-center space-x-3 text-gray-700 py-2 rounded-md font-medium hover:bg-sky-50 focus:bg-gray-200 focus:shadow-outline">
                            <label for="tipo-evento-modal" class="cursor-pointer"><lord-icon 
                            src="https://cdn.lordicon.com/mecwbjnp.json"
                            trigger="hover"
                            colors="primary:#121331,secondary:#000000">
                        </lord-icon></label>
                        <label for="tipo-evento-modal" class="cursor-pointer self-center">Crear Evento</label>
                    </div>
                    {{-- </a> --}}
                </li>
                <li class="w-48">
