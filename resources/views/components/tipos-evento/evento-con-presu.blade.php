<article>
    <div class="flex justify-between border border-black bg-lime-50 p-3">
        <div>
            <h3 class="text-center border border-black rounded-md bg-amber-600 font-semibold">Evento CON PRESUPUESTO</h3>
    ...
    <div class="flex border border-black bg-violet-400 pl-2">
        ...
        <h5 class="border border-black bg-blue-400 pl-2 mx-1">PRESUPUESTO</h5>
