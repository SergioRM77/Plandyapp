<x-layouts.base titulo="Acerca de ..." metaDescription="Acerca de ... Plandyapp">
    ...
    <h2>Acerca de ...</h2>
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-7xl overflow-auto">
        <div class="md:flex">
          ...
          <div class="p-8">
            ...
            <div class="grid grid-flow-row items-baseline justify-between">
